    ...
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          ...
          <form onSubmit={form === 'login' ? handleLogin : handleRegister} className="space-y-4">
            <div>
            ...
            <button type="submit" className="w-full py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600">{form}</button>
          </form>
          <button
            onClick={() => setForm((prev) => (prev === 'login' ? 'register' : 'login'))}
